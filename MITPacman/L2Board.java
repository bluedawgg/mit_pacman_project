...
public class L2Board extends JPanel
{
  ...
  */
  ...
  Player player = new Player(380,380);
...
//    pellets[10][8] = false;
  ...
  */
  ...
  public void drawBoard(Graphics g)
  {
        ...
        g.setColor(Color.WHITE);
        g.fillRect(60,340,20,20);
        updateMap(60,340,20,20);
        ...
        updateMap(340,340,20,20);
        
        g.setColor(Color.cyan);
        g.fillRect(100,320,20,60); //M
        updateMap(100,320,20,60);
        g.fillRect(120,320,60,20);
        updateMap(120,320,60,20);
        g.fillRect(140,340,20,20);
        updateMap(140,340,20,20);
        g.fillRect(180,320,20,60);
        updateMap(180,320,20,60); // M
        g.fillRect(220,320,20,60); //I
        updateMap(220,320,20,60);
        g.fillRect(260,320,60,20);
        updateMap(260,320,60,20);
        g.fillRect(280,340,20,40); // T
        updateMap(280,340,20,40);
        
        
        g.setColor(Color.RED);
        g.fillRect(100,40,20,60); //M
        updateMap(100,40,20,60);
        g.fillRect(120,40,60,20);
        updateMap(120,40,60,20);
        
        g.fillRect(140,60,20,20);
        updateMap(140,60,20,20);
        
        g.fillRect(180,40,20,60);
        updateMap(180,40,20,60); // M
        
        g.fillRect(220,40,20,60); //I
        updateMap(220,40,20,60);
        g.fillRect(260,40,60,20);
        updateMap(260,40,60,20);
        g.fillRect(280,60,20,40); // T
        updateMap(280,60,20,40);
        
        g.setColor(Color.CYAN);
        g.fillRect(60,100,20,60); // T
        updateMap(60,100,20,60);
        
        g.setColor(Color.RED);
        g.fillRect(60,260,20,60); // T
        updateMap(60,260,20,60);
        
        g.setColor(Color.CYAN);
        g.fillRect(340,100,20,60); // T
        updateMap(340,100,20,60);
        
        g.setColor(Color.RED);
        g.fillRect(340,260,20,60); // T
        updateMap(340,260,20,60);
