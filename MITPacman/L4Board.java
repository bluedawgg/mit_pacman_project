...
public class L4Board extends JPanel
{
...
//          updateMap(120,320,20,60);
  ...
  public void setstats(Stats a,int c, int np, int li){
      a.jTextField1.setText(Integer.toString(c));
      a.jTextField2.setText(Integer.toString(np));
      a.jTextField3.setText(Integer.toString(li));
  }
        ...
        if (dying == 0)
        {
          if (numLives==-1)
          {
            ...
            /* Game over for player.  If relevant, update high score.  Set gameOver flag*/
              ...
              overScreen=true;
              Stats o = new Stats();
              setstats(o,currScore,player.pelletsEaten,2);
              o.setVisible(true);
            }
          }
        }
    ...
    if ( pellets[player.pelletX][player.pelletY] && New!=2 && New !=3)
    {
      ...
      if (player.pelletsEaten == 50)
      {
        ...
        if (!demo)
        {
          ...
          winScreen = true;
          Stats w = new Stats();
          setstats(w,currScore,player.pelletsEaten,cLives-numLives);
          w.setVisible(true);
