...
public class L3Board extends JPanel
{
  ...
  */
  ...
  Player player = new Player(0,380);
  Ghost2 ghost1 = new Ghost2(180,180);
  Ghost2 ghost2 = new Ghost2(200,180);
  Ghost2 ghost3 = new Ghost2(220,180);
  Ghost2 ghost4 = new Ghost2(220,180);
  ...
  */
  ...
  public void drawBoard(Graphics g)
  {
        ...
        g.fillRect(40,360,120,20);
        updateMap(40,360,120,20);
        ...
        g.fillRect(20,120,40,60);
          updateMap(20,120,40,60);
        g.fillRect(360,120,40,60);
          updateMap(360,120,40,60);
        g.fillRect(20,200,40,60);
          updateMap(20,200,40,60);
        g.fillRect(360,200,40,60);
         updateMap(360,200,40,60);
  ...
  int powerX = (int) ((Math.random()*((19-1)+1))+1);
  int powerY = (int) ((Math.random()*((19-1)+1))+1);
  ...
  public void drawPellets(Graphics g)
  {
        ...
        for (int i=1;i<20;i++)
        {
          for (int j=1;j<20;j++)
          {
//            if(pellets[powerX-1][powerY-1]){
//                g.setColor(Color.BLUE);
//                g.fillOval(powerX*20+8,powerY*20+8,4,4);
//            }
            g.setColor(Color.YELLOW);
            if ( pellets[i-1][j-1])
...
//    else{
  ...
  public void paint(Graphics g)
  {
    ...
    if (New==1)
    {
      ...
      ghost1 = new Ghost2(180,180);
      ghost2 = new Ghost2(200,180);
      ghost3 = new Ghost2(220,180);
      ghost4 = new Ghost2(220,180); 
      currScore = 0;
      drawBoard(g);
      drawPellets(g);
      drawLives(g);
