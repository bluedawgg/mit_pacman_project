...
public class Board extends JPanel
{
  ...
  /* For JAR File*/
  /*
  Image pacmanImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/pacman.jpg"));
  Image pacmanUpImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/pacmanup.jpg")); 
  Image pacmanDownImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/pacmandown.jpg")); 
  Image pacmanLeftImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/pacmanleft.jpg")); 
  Image pacmanRightImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/pacmanright.jpg")); 
  Image ghost10 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost10.jpg")); 
  Image ghost20 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost20.jpg")); 
  Image ghost30 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost30.jpg")); 
  Image ghost40 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost40.jpg")); 
  Image ghost11 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost11.jpg")); 
  Image ghost21 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost21.jpg")); 
  Image ghost31 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost31.jpg")); 
  Image ghost41 = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/ghost41.jpg")); 
  Image titleScreenImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/titleScreen.jpg")); 
  Image gameOverImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/gameOver.jpg")); 
  Image winScreenImage = Toolkit.getDefaultToolkit().getImage(Pacman.class.getResource("D:/MITPacman/img/winScreen.jpg"));
  */
  /* For NOT JAR file*/
  Image pacmanImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/pacman.jpg"); 
  Image pacmanUpImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/pacmanup.jpg"); 
  Image pacmanDownImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/pacmandown.jpg"); 
  Image pacmanLeftImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/pacmanleft.jpg"); 
  Image pacmanRightImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/pacmanright.jpg"); 
  Image ghost10 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost10.jpg"); 
  Image ghost20 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost20.jpg"); 
  Image ghost30 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost30.jpg"); 
  Image ghost40 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost40.jpg"); 
  Image ghost11 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost11.jpg"); 
  Image ghost21 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost21.jpg"); 
  Image ghost31 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost31.jpg"); 
  Image ghost41 = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/ghost41.jpg"); 
  Image titleScreenImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/Pac_Titlescreen460.png"); 
  Image gameOverImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/pacdead.png"); 
  Image winScreenImage = Toolkit.getDefaultToolkit().getImage("D:/MITPacman/img/pacwin.png");

  /* Initialize the player and ghosts */
  Player player = new Player(20,380);
...
//    pellets[10][8] = false;
  ...
  */
  ...
  public void drawBoard(Graphics g)
  {
        ...
        g.fillRect(40,320,20,40);
        updateMap(40,320,20,40);
        g.fillRect(40,320,60,20);
        updateMap(40,320,60,20);
        g.fillRect(80,340,20,20);
        updateMap(80,340,20,20);
        
        g.fillRect(40,40,20,40);
        updateMap(40,40,20,40);
        g.fillRect(60,40,40,20);   //ab5
        updateMap(60,40,40,20);
        g.fillRect(100,40,20,40);
        updateMap(100,40,20,40);
        
        g.fillRect(140,40,20,40);
        updateMap(140,40,20,40);
        g.fillRect(160,40,40,20);   //block15
        updateMap(160,40,40,20);
        g.fillRect(200,40,20,40);
        updateMap(200,40,20,40);
        
        g.fillRect(40,160,20,100); //block13
        updateMap(40,160,20,100);
        g.fillRect(20,160,20,20); //block13
        updateMap(20,160,20,20);
        g.fillRect(20,200,20,20); //block13
        updateMap(20,200,20,20);
        g.fillRect(20,240,20,20); //block13
        updateMap(20,240,20,20);
  
        
        g.fillRect(280,60,20,60);
        updateMap(280,60,20,60); 
        g.fillRect(300,60,40,20);
        updateMap(300,60,40,20);
        g.fillRect(320,80,20,20);
        updateMap(320,80,20,20);
        g.fillRect(300,100,40,20);
        updateMap(300,100,40,20);   // blockX
        g.fillRect(340,100,40,20);
        updateMap(340,100,40,20);
        g.fillRect(320,120,20,40);
        updateMap(320,120,30,40);
        g.fillRect(340,140,40,20);
        updateMap(340,140,40,20);
        g.fillRect(360,120,20,20);
        updateMap(360,120,20,20);
         g.fillRect(300,340,60,20); 
        updateMap(300,340,60,20);
        g.fillRect(280,380,60,20); 
        updateMap(280,380,60,20);
        
        Color c = new Color(165,42,42);
        g.setColor(c);
        g.fillRect(340,200,20,20);
        updateMap(340,200,20,20);
        g.fillRect(320,220,60,80);
        updateMap(320,220,60,80);
        g.fillRect(340,300,20,20);
        updateMap(340,300,20,20);
...
//          updateMap(320,200,80,60);
        ...
        g.fillRect(180,340,20,20); //walks
        updateMap(180,340,20,20);
        g.fillRect(220,340,20,20); 
        updateMap(220,340,20,20);
        g.fillRect(120,120,20,60); //walls
